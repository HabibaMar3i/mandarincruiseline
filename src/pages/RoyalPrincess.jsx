            ...
            <section className="relative h-screen overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center h-full px-4">
                    <div className="text-center text-white max-w-4xl mx-auto">
                        ...
                        <Link 
                            to="/contact-us"
                            className="bg-[#a1978a] text-white px-12 py-4 text-xl font-semibold font-georgia rounded-full hover:opacity-90 transition-all duration-300 inline-block"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div data-aos="fade-up" data-aos-delay="200">
                            <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-6">Technical Specifications</h3>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-xl overflow-hidden" data-aos="fade-up">
                            ...
                            <div className="p-8">
                                <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Standard Cabins</h3>
                        ...
                        <div className="bg-white rounded-xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div className="p-8">
                                <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Royal Suites</h3>
            ...
            <section className="py-16 px-6 bg-white">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                        {/* Sun Deck */}
                        <div className="bg-gradient-to-r from-[#a1978a] to-[#AA8C77] rounded-xl p-8 text-white" data-aos="fade-up">
                        ...
                        {/* Lounge Deck */}
                        <div className="bg-white border-2 border-[#a1978a] rounded-xl p-8" data-aos="fade-up" data-aos-delay="100">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                <img src="/RoyalPrincess/Royal Princess (6).webp" alt="Lounge Deck" className="rounded-lg" />
                                <div>
                                    <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Lounge Deck (D)</h3>
                        ...
                        {/* Upper Deck */}
                        <div className="bg-gradient-to-r from-[#a1978a] to-[#AA8C77] rounded-xl p-8 text-white" data-aos="fade-up" data-aos-delay="200">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                <div>
                        ...
                        {/* Main Deck */}
                        <div className="bg-white border-2 border-[#a1978a] rounded-xl p-8" data-aos="fade-up" data-aos-delay="300">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                <img src="/RoyalPrincess/Royal Princess (12).webp" alt="Main Deck" className="rounded-lg" />
                                <div>
                                    <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Main Deck (B)</h3>
                                    <ul className="space-y-2 font-hero text-[#919090]">
                        ...
                        {/* Lower Deck */}
                        <div className="bg-gradient-to-r from-[#a1978a] to-[#AA8C77] rounded-xl p-8 text-white" data-aos="fade-up" data-aos-delay="400">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                <div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center" data-aos="fade-up">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Main Restaurant</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Entertainment</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Pool & Jacuzzi</h3>
            ...
            <section className="py-16 px-6 bg-white">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-[#a1978a] to-[#AA8C77] rounded-xl p-8 text-white" data-aos="fade-up">
                        ...
                        <div className="bg-white border-2 border-[#a1978a] rounded-xl p-8" data-aos="fade-up" data-aos-delay="200">
                            <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-6">3 Nights / 4 Days</h3>
                            <p className="text-xl font-hero text-[#a1978a] mb-6">Aswan to Luxor</p>
                            <div className="space-y-4 font-hero text-[#919090]">
                                <div>
