                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-xl overflow-hidden" data-aos="fade-up">
                            ...
                            <div className="p-8">
                                <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Junior Suites</h3>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white border-2 border-[#a1978a] rounded-xl p-8" data-aos="fade-up" data-aos-delay="100">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div>
                                    <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">Tokyo Bar Deck (D)</h3>
                        ...
                        <div className="bg-white border-2 border-[#a1978a] rounded-xl p-8" data-aos="fade-up" data-aos-delay="300">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div>
                                    <h3 className="text-3xl font-bold font-georgia text-[#a1978a] mb-4">The Reception (B)</h3>
                                    <ul className="space-y-2 font-hero text-[#919090]">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center" data-aos="fade-up">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Gourmet Dining</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Live Entertainment</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-2">Premium Facilities</h3>
