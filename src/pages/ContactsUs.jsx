        ...
        <div>
            ...
            <section className="py-16 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg font-georgia text-[#919090] max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-xl p-8 text-center" data-aos="fade-up">
                            <div className="bg-gradient-to-br from-[#a68b76] to-[#AA8C77] text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                        ...
                        <div className="bg-white rounded-xl shadow-xl p-8 text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a68b76] mb-4">Email Us</h3>
                            <p className="font-georgia text-[#919090] mb-4">
                                info@mandarincruiseline.com<br />
                            </p>
                            <p className="text-sm font-georgia text-[#a68b76] font-semibold">Quick Response</p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-xl p-8 text-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a68b76] mb-4">Visit Us</h3>
                            <p className="font-georgia text-[#919090] mb-4">
                                22, Kasr El Nil St.<br />
                                Cairo, Egypt
                            </p>
                            <p className="text-sm font-georgia text-[#a68b76] font-semibold">Egypt</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div data-aos="fade-up">
                            <h2 className="text-4xl font-bold font-georgia text-[#a68b76] mb-6">
                                Plan Your Dream Cruise
                            </h2>
                            <p className="text-lg font-georgia text-[#919090] mb-8 leading-relaxed">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center space-x-4">
                                    <div className="bg-[#a68b76] text-white p-2 rounded-full">
                                        <i className="fas fa-check"></i>
                                    </div>
                                    <span className="font-georgia text-[#919090]">Personalized cruise planning</span>
                                </div>
                                <div className="flex items-center space-x-4">
                                    <div className="bg-[#a68b76] text-white p-2 rounded-full">
                                        <i className="fas fa-check"></i>
                                    </div>
                                    <span className="font-georgia text-[#919090]">Expert local knowledge</span>
                                </div>
                                <div className="flex items-center space-x-4">
                                    <div className="bg-[#a68b76] text-white p-2 rounded-full">
                                        <i className="fas fa-check"></i>
                                    </div>
                                    <span className="font-georgia text-[#919090]">24/7 customer support</span>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-16 px-6">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-[#a68b76] to-[#AA8C77] rounded-2xl p-8 md:p-12 text-white">
                        ...
                        <div className="text-center mt-8 pt-8 border-t border-white/20">
                            ...
                            <div className="flex justify-center">
                                <a href="https://www.instagram.com/mandarincruiseline/?hl=en" target="_blank" rel="noopener noreferrer" className="bg-white text-[#a68b76] p-3 rounded-full hover:scale-110 transition-transform duration-300">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center" data-aos="fade-up">
                            <div className="bg-[#a68b76] text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                                <i className="fas fa-star text-2xl"></i>
                            </div>
                            <h3 className="text-2xl font-bold font-georgia text-[#a68b76] mb-4">5-Star Luxury</h3>
                            <p className="font-georgia text-[#919090]">Superior deluxe floating hotels with world-class amenities and service</p>
                        </div>
                        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
                            <div className="bg-[#a68b76] text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                                <i className="fas fa-shield-alt text-2xl"></i>
                            </div>
                            <h3 className="text-2xl font-bold font-georgia text-[#a68b76] mb-4">Safety First</h3>
                            <p className="font-georgia text-[#919090]">Built under international supervision with CRISTAL certification</p>
                        </div>
                        <div className="text-center" data-aos="fade-up" data-aos-delay="200">
                            <div className="bg-[#a68b76] text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                                <i className="fas fa-heart text-2xl"></i>
                            </div>
                            <h3 className="text-2xl font-bold font-georgia text-[#a68b76] mb-4">Unforgettable Experience</h3>
                            <p className="font-georgia text-[#919090]">Create memories that last a lifetime on the majestic Nile River</p>
                        </div>
                    </div>
                </div>
            </section>
