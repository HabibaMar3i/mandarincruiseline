        ...
        <div>
                ...
                <div className="relative z-10 flex items-center justify-center h-full px-4">
                    <div className="text-center text-white max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="400">
                            <a href="tel:+20257572151" className="bg-[#a1978a] text-white px-8 py-4 text-lg font-semibold font-georgia rounded-full hover:opacity-90 transition-all duration-300 inline-block">
                                <i className="fas fa-phone mr-2"></i>Call Now
                            </a>
                            <a href="mailto:info@mandarincruise.com" className="bg-white text-[#a1978a] px-8 py-4 text-lg font-semibold font-georgia rounded-full hover:shadow-lg transition-all duration-300 inline-block">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div data-aos="fade-up">
                            <h2 className="text-4xl font-bold font-georgia text-[#a1978a] mb-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center space-x-4">
                                    <div className="bg-[#a1978a] text-white p-2 rounded-full">
            ...
            <section className="py-16 px-6">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-[#a1978a] to-[#AA8C77] rounded-2xl p-8 md:p-12 text-white">
                        ...
                        <div className="text-center mt-8 pt-8 border-t border-white/20">
                            ...
                            <div className="flex justify-center space-x-4">
                                <a href="#" className="bg-white text-[#a1978a] p-3 rounded-full hover:scale-110 transition-transform duration-300">
            ...
            <section className="relative py-24 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="400">
                        <a href="tel:+20257572151" className="bg-[#a1978a] text-white px-12 py-4 text-xl font-semibold font-georgia rounded-full hover:opacity-90 transition-all duration-300 inline-block">
                            <i className="fas fa-phone mr-2"></i>Call Now
                        </a>
                        <a href="mailto:info@mandarincruise.com" className="bg-white text-[#a1978a] px-12 py-4 text-xl font-semibold font-georgia rounded-full hover:shadow-lg transition-all duration-300 inline-block">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center" data-aos="fade-up">
                            <div className="bg-[#a1978a] text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                                <i className="fas fa-star text-2xl"></i>
                            </div>
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-4">5-Star Luxury</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-4">Safety First</h3>
                        ...
                        <div className="text-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h3 className="text-2xl font-bold font-georgia text-[#a1978a] mb-4">Unforgettable Experience</h3>
