...
const Testimonials = () => {
    ...
    return (
        <section className="relative py-20 overflow-hidden bg-[#a1978a]">
            <div 
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6">
                ...
                <div className="bg-white bg-opacity-95 rounded-xl p-8 md:p-12 shadow-2xl">
                    <div className="text-center">
                        <div className="mb-8">
                            <svg className="w-12 h-12 text-[#a1978a] mx-auto mb-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="transition-opacity duration-500">
                            ...
                            <div>
                                <h4 className="text-xl font-bold font-georgia text-[#a1978a] mb-1">
