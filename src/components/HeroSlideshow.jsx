        ...
        <div className="relative h-screen overflow-hidden w-full">
            ...
            <div className="relative z-10 flex items-center justify-center h-full px-4">
                <div className="text-center text-white max-w-4xl mx-auto">
                    ...
                    <p className="text-lg sm:text-xl md:text-2xl leading-relaxed font-georgia text-[#EFE8E1]">
                        Five-Star Deluxe Floating Hotel Experience
                    </p>
                    <button className="mt-8 bg-[#a68b76] text-white px-8 py-3 text-lg font-semibold rounded hover:opacity-90">
                        Explore Our Fleet
                    </button>
                </div>
            </div>
